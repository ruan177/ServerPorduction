...
export { DeleteUserController } from "./deleteUser/DeleteUserController";
export { RefreshTokenUserController } from "./refreshTokenUser/RefreshTokenUserController";
export { GetCoursesControler } from "./getCourses/GetCoursesController";
export { GetUsersController } from "./getUsers/GetUsersController";
export { GetCoursesByIdController } from "./getCourseById/GetCourseByIdController"
...
export {UpdateUsersController} from "./updateUsers/UpdateUsersController";
export {UpdateCoursesController} from "./updateCourses/UpdateCoursesController";
